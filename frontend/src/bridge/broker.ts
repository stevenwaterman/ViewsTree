...
import type { Config } from "../state/settings";
import type { NodeState, NodeStore } from "../state/trackTree";
import type { Section, SectionState } from "../state/section";
...
import type { ProcessedActiveNotes } from "./postProcessor";
